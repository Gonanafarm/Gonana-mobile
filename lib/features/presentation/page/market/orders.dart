                                          ...
                                          return ListView.builder(
                                              ...
                                              itemBuilder:
                                                  (BuildContext context,
                                                      int index) {
                                                log("UI status: ${orderController.getOrderModel.value.data![index].status}");
                                                print(index);
                                                                        ...
                                                                        children: [
                                                                          Flexible(
                                                                            child:
                                                                              ...
                                                                              style: const TextStyle(overflow: TextOverflow.ellipsis, fontSize: 12, fontWeight: FontWeight.w600, color: Colors.black),
                                                                            ),
                                                                          ),
                                                                          sizeHor(
                                                                              5),
                                                                          Flexible(
                                                                            child:
                                                                              ...
                                                                              return Text(
                                                                                ...
                                                                                style: TextStyle(
                                                                                  color: orderController.getOrderModel.value.data![index].status == "pending" ? Colors.yellow.shade700 : Color(0xFF31DE72),
                                                                                  fontSize: 14,
                                                                                          ...
                                                                                          actions: [
                                                                                            Center(
                                                                                              ...
                                                                                              onPressed: () async {
                                                                                                ...
                                                                                                if (success["statusCode"] == 201) {
                                                                                                  setState(() {
                                                                                                    response = "Item confirmation sent successfully";
