...
import 'package:gonana/features/presentation/widgets/image_slider_discount.dart';
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                sizeVer(10.0),
                ImageSliderHotDeals(imageProductModel: widget.productModel),
                sizeVer(10.0),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    RichText(
                      text: TextSpan(
                        children: [
                          TextSpan(
                            text: widget.productModel!.amount != null
                                ? "NGN ${widget.productModel!.amount}"
                                : "NGN ",
                ...
                Text(
                    widget.productModel!.title!.isNotEmpty
                ...
                sizeVer(3.0),
                Text(
                    widget.productModel!.body!.isNotEmpty
                        ? "${widget.productModel!.body}"
                        : "",
                    style: GoogleFonts.montserrat(
                        fontSize: 10,
                        color: darkColor,
                  ...
                  children: [
                    ...
                    Text(
                        widget.productModel!.quantity! != null
                            ? "${widget.productModel!.quantity} Pieces available"
                            : "0 Pieces available",
                        style: GoogleFonts.montserrat(
                            fontSize: 10,
                            color: darkColor,
                    ...
                    GestureDetector(
                      onTap: () async {
                        ...
                        created = await cartController.addToCart(
                            widget.productModel.id, context);
                        if (created) {
