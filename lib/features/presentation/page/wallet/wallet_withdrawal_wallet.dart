...
class WithdrawalWalletOptions extends StatefulWidget {
  const WithdrawalWalletOptions({super.key});

  @override
  State<WithdrawalWalletOptions> createState() =>
      _WithdrawalWalletOptionsState();
}

class _WithdrawalWalletOptionsState extends State<WithdrawalWalletOptions> {
  @override
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Container(
                      ...
                      child: ListTile(
                        onTap: () {
                          Get.to(() => WithdrawalWalletDetails());
                        },
