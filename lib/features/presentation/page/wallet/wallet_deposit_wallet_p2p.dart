...
class WalletP2P extends StatefulWidget {
  const WalletP2P({super.key});

  @override
  State<WalletP2P> createState() => _WalletP2PState();
}

class _WalletP2PState extends State<WalletP2P> {
  List<String> str = [
    "Go to your Kuda app, then tap 'send to username'",
    "Copy the Marchant name here and paste in kuda",
    "Copy the narration above and paste in kuda",
    "The Kuda account must have the same name as yours else transaction would be reversed "
  ];
